...
const NoticiastSchema = new mongoose.Schema({
    dateCreater: {
        type: Date,
        default: Date.now
    },
...
NoticiastSchema.pre('save', async function(next){
    try {
...
NoticiastSchema.plugin(mongoosePaginate)

mongoose.model('noticias', NoticiastSchema)